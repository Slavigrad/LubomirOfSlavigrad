...
import { Experience } from './cv-data.interface';
import { INDUSTRIES } from '../../shared/util-performance/constants/industry.constants';
...
export const experiences: Experience[] = [
  {
    ...
    company_size: 'medium',
    company_description:
      'Leading Swiss technology consultancy specializing in digital transformation and enterprise solutions',
    ...
    positions: [
      {
        ...
        description:
          'Developing and maintaining backend applications for Swiss federal projects and banking systems, focusing on workflow automation and digital onboarding processes.',
        technologies: [
          'Java 17',
          'Spring Boot 3',
          'Flowable',
        ...
        projects: [
          {
            ...
            description:
              'New Information System for Health Insurance Supervision - building the foundation for a data collection and analytics platform for all supervisory activities in insurance oversight',
          ...
          },
          {
            ...
            description:
              'Flowable upgrade and special permit application enhancement for Federal Roads Office',
            technologies: [
              'Flowable',
              'Java 17',
              'Spring Boot 3',
          ...
          },
          {
            ...
            description:
              'Backend applications for customer product ordering and video identification onboarding',
...

  {
    ...
    company_size: 'small',
    company_description:
      'Cloud-native technology company specializing in Kubernetes and modern software solutions',
    ...
    positions: [
      {
        ...
        description:
          'Developed sophisticated automotive backend system for Mercedes-Benz.io license administration using microservices architecture, showcasing expertise in modern cloud-native technologies.',
        technologies: [
          'Java 17',
          'Kotlin 1.8',
          'Spring Boot 3',
        ...
        projects: [
          {
            ...
            description:
              'Sophisticated automotive backend system for license administration using microservices architecture',
            technologies: [
              'Java 17',
              'Kotlin 1.8',
              'Spring Boot 3',
...

  {
    ...
    company_size: 'small',
    company_description:
      'Software development company working with Communi5, an Austrian manufacturer of communications solutions for service providers',
    ...
    positions: [
      {
        ...
        description:
          'Developed backend system called FeatureServer for Communi5 VoIP solution, focusing on web teleconferencing and call management with REST interface.',
        technologies: [
          'Java 8',
          'Java 17',
          'Gradle',
        ...
        projects: [
          {
            ...
            description:
              'Backend system for VoIP web teleconferencing with comprehensive call management capabilities',
            technologies: [
              'Java 17',
              'JAX-RS',
              'Jersey',
          ...
          },
          {
            ...
            description:
              'Major system upgrade from Java 8 to Java 17 with performance and security improvements',
...

  {
    ...
    company_size: 'medium',
    company_description:
      'Software development company specializing in infotainment systems and enterprise solutions',
    ...
    positions: [
      {
        ...
        description:
          'Developed infotainment systems for international train companies and maintained enterprise automotive systems for Porsche Informatik within Volkswagen Group.',
        technologies: [
          'C++ 11',
          'Boost',
          'ZeroMQ',
        ...
        projects: [
          {
            ...
            description:
              'Multicast streaming system for media distribution in international train companies',
            technologies: [
              'C++ 11',
              'Boost',
              'ZeroMQ',
          ...
          },
          {
            ...
            description:
              'Legacy C++ system maintenance for Volkswagen Group spare-parts ordering and aftersales workflows',
...

  {
    ...
    company_description:
      '3D graphics and computer vision technology company specializing in point cloud processing solutions',
    ...
    positions: [
      {
        ...
        description:
          'Led development of 3D Point Cloud Editor for scanned object processing, implementing point cloud registration algorithms to create consistent models from multiple scanning angles.',
        technologies: [
          'C++ 11',
        ...
        projects: [
          {
            ...
            description:
              'Advanced point cloud processing application for creating consistent 3D models from multiple scanned datasets',
            technologies: [
              'C++ 11',
              'Point Cloud Library',
              'VTK Library',
          ...
          },
          {
            ...
            description:
              'Innovative streaming solution for remote 3D application access using WebSocket technology',
            technologies: [
              'libwebsockets',
              'Nvidia GRID SDK',
              'H.264 encoding/decoding',
        ...
        mentoring: {
          ...
          success_stories: [
            'Team successfully delivered complex 3D application using modern C++ practices',
          ],
        },
        createdAt: new Date(),
        updatedAt: new Date(),
...

  {
    ...
    company_size: 'large',
    company_description:
      'Global information technology consulting, systems integration and outsourcing company',
    ...
    positions: [
      {
        ...
        description:
          'EAI specialist and Java developer working on telecommunications and financial sector projects, specializing in Tibco BusinessWorks and Spring framework solutions.',
        technologies: [
          'Tibco BW Designer 5.7',
        ...
        projects: [
          {
            ...
            description:
              'Tibco BusinessWorks EAI system development for Slovak national telecommunications operator',
            technologies: [
              'Tibco BW Designer 5.7',
              'Tibco Administrator 5.7',
              'Tibco EMS 6.1',
          ...
          },
          {
            ...
            description:
              'Java backend development for SEPA payment system implementation at financial institution',
            technologies: [
              'Java SE 6',
              'Java EE 6',
              'Spring Framework 4',
...

  {
    ...
    company_size: 'small',
    company_description:
      'Mobile application development company specializing in iOS applications for Slovak market',
    ...
    positions: [
      {
        ...
        description:
          'Led iOS mobile application development team, handling full development lifecycle from analysis and design to deployment for customer projects.',
        technologies: [
          'Objective-C',
          'Xcode',
          'JSON',
    ...
    positions: [
      {
        ...
        description:
          'EAI specialist developing Java and Vitria solutions for European telecommunications companies. Focused on system integration and enterprise application development.',
        ...
        projects: [
          {
            ...
            name: 'Slovak Telekom EAI System',
            description:
              'Enterprise application integration system for Slovak national telecommunications operator',
      ...
      },
      {
        ...
        description:
          'Senior EAI specialist and Tibco expert working on complex telecommunications projects across Europe. Led technical implementations and provided expertise in middleware solutions.',
        technologies: [
          'Tibco BusinessWorks',
          'Tibco BW Designer 5.6',
          'Tibco iProcess',
        ...
        projects: [
          {
            ...
            description:
              'Continued leadership of Slovak Telekom EAI system with enhanced responsibilities',
          ...
          },
          {
            ...
            description:
              'Tibco BusinessWorks implementation for Bulgarian national telecom operator - Site: Bratislava, Sofia',
            ...
            team_size: 3,
            results: [
              'Successfully delivered Tibco BW solution',
              'Improved system integration capabilities',
            ],
            createdAt: new Date(),
            updatedAt: new Date(),
          },
          {
            ...
            name: 'Vodafone UK',
            description:
              'Tibco BusinessWorks development for UK Vodafone operations - Site: Newbury, London',
            technologies: ['Tibco BW'],
          ...
          },
          {
            ...
            name: 'Vodafone CZ',
            description:
              'Tibco BusinessWorks implementation for Czech Vodafone operations - Site: Bratislava, Prague',
            technologies: ['Tibco BW'],
          ...
          },
          {
            ...
            name: 'Polkomtel S.A.',
            description:
              'Tibco BusinessWorks development for Polish telecommunications operator - Site: Warsaw, Rome',
            technologies: ['Tibco BW'],
            ...
            team_size: 12,
            results: [
              'Successfully implemented across Poland and Italy sites',
              'Delivered scalable middleware solution',
            ],
            createdAt: new Date(),
            updatedAt: new Date(),
          },
