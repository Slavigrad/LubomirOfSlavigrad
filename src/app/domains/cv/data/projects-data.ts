...
import { Project } from './cv-data.interface';
...
export const projects: Project[] = [
  {
    ...
    description:
      'A comprehensive digital platform showcasing the rich history and culture of Slavigrad. This immersive web experience combines storytelling with modern web technologies to create an interactive journey through the mythical realm.',
...
*/
  {
    ...
    description:
      'A comprehensive educational platform for visualizing and understanding neural networks, built with modern Angular architecture. Features interactive network design, real-time training visualization, and mathematical algorithm exploration. Designed with Swiss banking-grade UI/UX principles.',
