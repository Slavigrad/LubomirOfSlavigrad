    ...
    <div class="collapse-demo p-6 space-y-8 max-w-4xl mx-auto">
          ...
          >
            <div class="space-y-3">
              ...
              <div class="flex gap-2">
                ...
                <span class="px-2 py-1 bg-secondary/10 text-secondary rounded text-sm"
                  >Elegant</span
                >
              </div>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          >
            <div class="space-y-3">
              <p class="text-sm text-muted-foreground">
                Discover the advanced features that make this component library powerful and
                flexible.
              </p>
              <div class="flex flex-wrap gap-2">
          ...
          >
            <div class="space-y-3">
              ...
              />
              <p class="text-sm">
                A comprehensive example showing how collapsible cards can be used for project
                showcases.
              </p>
            </div>
            <div slot="footer">
      ...
      <section class="demo-section">
        ...
        >
          ...
          >
            <p class="text-muted-foreground">
              This is a comprehensive collapse component library built for Angular applications with
              modern design patterns, accessibility features, and smooth animations.
            </p>
          </app-collapse>
          ...
          <app-collapse variant="minimal" headerText="Is it accessible?" [expanded]="false">
            <p class="text-muted-foreground">
              Yes! All components include proper ARIA attributes, keyboard navigation support, focus
          ...
          >
            <p class="text-muted-foreground">
              Absolutely! The library is built with production-ready patterns including OnPush
              change detection, signal-based state management, and comprehensive error handling.
            </p>
          </app-collapse>
      ...
      <footer class="demo-footer text-center pt-8 border-t border-border/50">
        <p class="text-muted-foreground">
          This demo showcases the complete collapse component library. Check the documentation for
