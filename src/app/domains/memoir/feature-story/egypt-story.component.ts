...
import {
  ...
  NavigationChapter,
} from '../ui/chapter-navigation/chapter-navigation.component';
import { SocialShareComponent, ShareConfig } from '../ui/social-share/social-share.component';
...
@Component({
  ...
  template: `
    ...
    <div class="min-h-screen relative overflow-hidden">
      ...
      <div class="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        <div
          class="absolute top-0 left-1/4 w-96 h-96 bg-primary/10 rounded-full blur-3xl animate-float"
        ></div>
        <div
          class="absolute bottom-1/4 right-1/4 w-80 h-80 bg-secondary/10 rounded-full blur-3xl animate-float-delay"
        ></div>
        <div
          class="absolute top-1/2 left-1/2 w-72 h-72 bg-accent/10 rounded-full blur-3xl animate-pulse-glow"
        ></div>
        ...
        <section class="relative py-20 px-6">
          <div class="container mx-auto max-w-4xl">
            ...
            <div class="text-center mb-16 animate-fade-in-up">
              <h1
                class="text-5xl md:text-7xl font-bold mb-8 gradient-text-enhanced tracking-tight py-2"
              >
                {{ story.title }}
              </h1>
              ...
              <div
                class="flex items-center justify-center gap-3 mb-6 text-sm text-muted-foreground/80 animate-fade-in-up"
              ...
              <div
                class="featured-image-container my-12 animate-fade-in-up"
              ...
              <div
                class="flex flex-wrap items-center justify-center gap-4 text-muted-foreground text-sm animate-fade-in-up"
                style="animation-delay: 0.8s"
              >
                @for (meta of story.metadata; track meta; let i = $index) {
                  @if (i > 0) {
            ...
            <!-- Story Content -->
            <div
              class="glass-card-enhanced p-8 md:p-12 rounded-3xl border border-border/30 space-y-12 relative overflow-hidden animate-fade-in-up"
            ...
            >
              ...
              <div class="relative z-10">
                ...
                <div class="prose prose-invert max-w-none mb-16 space-y-6">
                  ...
                  @for (paragraph of getIntroductionParagraphs(); track paragraph; let i = $index) {
                    <p
                      ...
                      [class]="{
                        'first-letter:text-7xl first-letter:font-bold first-letter:text-primary first-letter:mr-3 first-letter:float-left first-letter:leading-none':
                          i === 0,
                      }"
                    >
                      {{ paragraph }}
                ...
                <!-- Chapters (Dynamic) -->
                @for (chapter of story.chapters; track chapter; let chapterIndex = $index) {
                  <div
                    ...
                    <div class="chapter-header relative group">
                      ...
                      >
                        ...
                        >
                          ...
                          <!-- Decorative icon -->
                          <svg
                            class="w-6 h-6 opacity-50 group-hover:opacity-100 transition-opacity"
                            fill="currentColor"
                            viewBox="0 0 24 24"
                          >
                            <path
                    ...
                    <div class="chapter-content space-y-8 pl-0 md:pl-8">
                      @for (section of chapter.sections; track section; let sectionIndex = $index) {
                        <div class="section-container space-y-4">
                          ...
                          <div class="space-y-4">
                            @for (
                              paragraph of section.paragraphs;
                              track paragraph;
                ...
                @if (story.closingQuote) {
                  <div class="mt-16 pt-12 border-t border-border/20">
                    <blockquote
                      class="text-center italic text-xl md:text-2xl text-muted-foreground relative"
                    >
                      <svg
                        class="w-12 h-12 text-primary/20 absolute -top-6 left-1/2 -translate-x-1/2"
                        fill="currentColor"
                        viewBox="0 0 24 24"
                      >
                      ...
                      <footer class="text-base mt-4 not-italic text-foreground/70">
                        — {{ story.closingQuote.author }}
                      </footer>
                    </blockquote>
                  </div>
                }
                ...
                @if (story.author) {
                  <div class="mt-12 pt-12 border-t border-border/20 text-center">
                    <p class="text-lg text-muted-foreground mb-6">
                      Written by
                      <span class="text-foreground font-semibold text-xl gradient-text-enhanced">{{
                        story.author.name
                      }}</span>
                    </p>
                    @if (story.author.links) {
                      <div class="flex items-center justify-center gap-6">
                        @if (story.author.links.linkedin) {
                          <a
                        ...
                        @if (story.author.links.instagram) {
                          <a
  ...
  styles: [
    `
      ...
      /* Enhanced Glass Card */
      .glass-card-enhanced {
        background: linear-gradient(135deg, hsl(var(--card-glass)) 0%, hsl(var(--card)) 100%);
